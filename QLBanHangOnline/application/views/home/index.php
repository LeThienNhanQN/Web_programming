<div class="row">
        <div class="col-md-12">
        <div class="alert alert-success text-center text-capitalize" role="alert">Chào Mừng Bạn Đến Với Hệ Thống Quản Lý Công Ty TNHH Thương Mại Và Dịch Vụ Tân Nhật Thanh</div>
    </div>
</div>
...
<div class="row" style="background:#CCFFFF; margin: 20px 0; overflow: hidden; ">
    <div class="col-md-4">
